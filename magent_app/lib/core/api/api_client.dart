...
class ApiClient {
  ...
  Future<Map<String, dynamic>> getAgentInfo() async {
    final resp = await dio.get('$apiPrefix/agent/info');
    return resp.data['data'];
  }

  // Projects
  Future<List<dynamic>> listProjects() async {
    final resp = await dio.get('$apiPrefix/projects');
    return resp.data['data'] ?? [];
  }
  ...
  Future<Map<String, dynamic>> getProject(String id) async {
    final resp = await dio.get('$apiPrefix/projects/$id');
    return resp.data['data'];
  }
  ...
  Future<Map<String, dynamic>> updateProject(
    ...
    final resp = await dio.put('$apiPrefix/projects/$id', data: data);
    return resp.data['data'];
  }

  Future<void> deleteProject(String id) async {
    await dio.delete('$apiPrefix/projects/$id');
  }
}
